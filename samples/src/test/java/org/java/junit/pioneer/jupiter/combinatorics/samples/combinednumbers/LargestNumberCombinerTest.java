...
import static org.java.junit.pioneer.jupiter.combinatorics.samples.combinednumbers.LargestNumberCombiner.largestNumber;
import static org.junit.jupiter.api.Assertions.assertEquals;

public class LargestNumberCombinerTest {
    private static final CombinatoricsGenerator generator = new LoopingGenerator();
    ...
    void test_2_strings(String left, String right) {
        ...
        BigInteger actual = largestNumber(left, right);
    ...
    void test_3_strings(String left, String middle, String right) {
        ...
        BigInteger actual = largestNumber(left, middle, right);
        assertEquals(expected, actual);
    }
