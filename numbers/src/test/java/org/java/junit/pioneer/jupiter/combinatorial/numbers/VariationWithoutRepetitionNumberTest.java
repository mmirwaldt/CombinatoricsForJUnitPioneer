...
public class VariationWithoutRepetitionNumberTest {
    ...
    @Test
    void test_2_trinary_digits() {
        VariationWithoutRepetitionNumber number = new VariationWithoutRepetitionNumber(3, 2);
        assertEquals(0, number.digit(0));
        assertEquals(1, number.digit(1));
    }

    @Test
    void test_2_trinary_digits_increment_carry_over() {
        VariationWithoutRepetitionNumber number = new VariationWithoutRepetitionNumber(3, 2);
        assertEquals(0, number.digit(0));
        assertEquals(1, number.digit(1));
        number.increment();
    ...
    @Test
    void test_2_trinary_digits_increment_carry_over_and_increment() {
        VariationWithoutRepetitionNumber number = new VariationWithoutRepetitionNumber(3, 2);
        number.increment();
        number.increment();
        number.increment();
