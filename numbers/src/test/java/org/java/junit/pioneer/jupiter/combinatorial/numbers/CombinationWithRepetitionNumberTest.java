...
public class CombinationWithRepetitionNumberTest {
    @Test
    void test_1_binary_digit_value_0() {
        CombinationWithRepetitionNumber number = new CombinationWithRepetitionNumber(2, 1);
    ...
    void test_2_binary_digits_length_2() {
        CombinationWithRepetitionNumber number = new CombinationWithRepetitionNumber(2, 2);
        assertEquals(0, number.digit(0));
    ...
    void test_3_trinary_digits_length_2() {
        CombinationWithRepetitionNumber number = new CombinationWithRepetitionNumber(3, 2);
        assertEquals(0, number.digit(0));
        assertEquals(0, number.digit(1));
        number.increment();
        assertEquals(0, number.digit(0));
